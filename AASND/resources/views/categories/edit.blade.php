...
@section('header')
    <h1 style="font-size: 1.875rem; font-weight: bold; color: #111827;">Edit Category</h1>
@endsection
    ...
    <div class="card">
        <form action="{{ route('admin.categories.update', $category) }}" method="POST">
            ...
            <div style="margin-bottom: 1rem;">
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $category->name) }}" style="width: 100%; padding: 0.625rem; border: 1px solid #d1d5db; border-radius: 0.375rem;" required>
                @error('name')
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <textarea name="description" id="description" rows="4" style="width: 100%; padding: 0.625rem; border: 1px solid #d1d5db; border-radius: 0.375rem;">{{ old('description', $category->description) }}</textarea>
            </div>
